"""Benchmark for Day 01 solutions."""
import sys
import time
...
def benchmark_part1(iterations=100):
    ...
    fileInfo = {"file": "src/data/day01.input.dat"}
    
    start_time = time.perf_counter()
    for _ in range(iterations):
        result = day01.solve_part1(fileInfo)
...
def benchmark_part2(iterations=100):
    ...
    start_time = time.perf_counter()
    for _ in range(iterations):
        result = day01.solve_part2(fileInfo)
    end_time = time.perf_counter()
